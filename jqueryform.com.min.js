    ...
    var b = function (b) {
                ...
                , d = {
                    ...
                    , disable: function () {
                        d.$container().each(function () {
                            a(this).addClass("jf-disabled"), a(this).find(":input").prop("disabled", !0).addClass("tmp-disabled")
                        }), d.trigger("logic:disable")
                    }
                    , enable: function () {
                        d.$container().each(function () {
                            a(this).removeClass("jf-disabled"), a(this).find(":input.tmp-disabled").prop("disabled", !1).removeClass("tmp-disabled")
        ...
        , d = function (a) {
            ...
            var d = this
                ...
                , l = function () {
                    e = h[d.match](), console.log("doAction: " + e), e && (console.log("going to " + d.action + " " + d.selector), i[d.action]())
                };
    ...
    , function () {
        ...
        function c() {
            var a = /^https*:\/\/[^.]*\.*jquery\-*form\.com\//i
                ...
                , d = b && !c;
            d && $(".jf-form").html("<h1>Sorry, directly accessing the form generated by <a href='http://jqueryform.com'>jqueryform.com</a> is not allowed.</h1>")
        }
        ...
        function e() {
            ...
            $(c).length ? $(c).prop("href", "http://www.jqueryform.com").text("") : $(decodeURIComponent(a)).appendTo($(b + "form")), $(c).show()
        }
            ...
            if (c) {
                ...
                $(f).change(function () {
                    ...
                    for (var h = 0, i = d.length; i > h; h++) {
                        var j = d[h]
                            , k = String(j.value).replace(/^\s+|\s+$/, "")
                            , l = "" == k ? "" : 'value="' + k.replace('"', "&quot;").replace("#empty", "").replace("#novalue", "") + '"';
                        f.push("<option " + l + ">" + j.label + "</option>")
                    }
                    $(b).append(f.join())
                })
            }
